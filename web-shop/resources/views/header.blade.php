					...
					<div class="cart" id="change-cart">
						...
						<div class="beta-dropdown cart-body">
							...
							<div class="cart-item">
								...
								<div class="media">
									<a class="pull-left" href="#"><img src="image/product/{{$product['item']['image']}}"
											alt=""></a>
									<div class="media-body">
										<span class="cart-item-title">{{$product['item']['name']}}</span>
										<span class="cart-item-amount">{{$product['qty']}}*<span>@if($product['item']['promotion_price']==0){{number_format($product['item']['unit'])}}
												@else
							...
							<div class="cart-caption">
								<div class="cart-total text-right">Tổng tiền: <span
										class="cart-total-value">@if(Session::has('cart')){{number_format($totalPrice)}}
										@else 0 @endif đồng</span></div>
								<div class="clearfix"></div>

								<div class="center">
									<div class="space10">&nbsp;</div>
									<a href="{{route('trang-dat-hang')}}" class="beta-btn primary text-center">Đặt hàng <i

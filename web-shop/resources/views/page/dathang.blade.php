...
<body>
	<div class="container">
		<div id="content">
            ...
            <div class="row">
               <h5 style="color:blue;" >@if(Session::has('thongbao')){{Session::get('thongbao')}}@endif</h5>
            </div>
			   ...
			   <div class="row">
				<div class="row">
					...
					<div class="col-sm-6">
                              ...
                              @if(Session::has('cart'))
								...
								<div class="your-order-item">
									...
									<div class="pull-right">
										<h5 class="color-black">@if(Session::has('cart')){{number_format(Session::get('cart')->totalPrice)}}@else 0 @endif đồng</h5>
									</div>
									<div class="clearfix"></div>
								</div>
							</div>
                     ...
                     <div class="form-block">
                        <label for="notes">Ghi chú</label>
                        <textarea id="notes" name="ghi_chu"></textarea>
						   </div>
							<div class="text-center"><button type="submit" class="bg-primary">Đặt hàng <i
										class="fa fa-chevron-right"></i></a></button></div>
						</div> <!-- .your-order -->
					</div>
				</div>
			</form>
